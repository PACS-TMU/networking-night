...
export const TimerContainer = ({ days, hours, minutes, seconds }) => {
    ...
    return (
        <div className="py-4 my-2 rounded-xl">
            <div className="grid grid-cols-2 gap-4 py-6 px-10 md:flex md:items-center md:justify-between md:mt-0 rounded-xl md:px-6 md:py-0 ">
